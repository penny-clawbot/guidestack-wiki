...
readingTime: "2 min"
---
# MACD Crypto Trading Strategy: A Complete Guide
...
1. **MACD line** – the difference between a 12‑period EMA and a 26‑period EMA of the closing price.  
2. **Signal line** – a 9‑period EMA of the MACD line.  
3. **Histogram** – the visual representation of the gap between the MACD line and the signal line.
