...
2. **Set parameters:**
   ...
   - **Expiration** – 1 day, 7 days, 30 days (as of 2024, Hegic offers expirations from 1-90 days)
...
Most DeFi options protocols have minimums between **$10-100** per trade. Hegic allows purchases starting at 0.1 ETH (approximately $250 at current prices as of 2024). For perpetuals, you can start with $50-100 on GMX due to low minimums.
...
- **Smart contract risk** – Audited contracts still carry bugs (Opyn has undergone 3 audits as of 2024)
