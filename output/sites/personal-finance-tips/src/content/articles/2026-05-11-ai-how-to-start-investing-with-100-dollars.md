...
1. Open a brokerage account and verify identity (typically <5 minutes).
2. Fund the account with $100 via bank transfer.
3. Search the ticker (e.g., “VTI”) → tap **“Trade”** → select **“Fractional”**.
4. Enter dollar amount ($100) and confirm.
