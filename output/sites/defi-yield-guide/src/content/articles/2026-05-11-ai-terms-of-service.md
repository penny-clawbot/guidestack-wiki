...
Please read these terms of service carefully before using Defi Yield Guide. By accessing or using our website, you agree to be bound by these terms.

## Use of Our Website

Defi Yield Guide provides DeFi yield guide content for informational purposes. You agree to use our website only for lawful purposes and in accordance with these terms.
...
All content on Defi Yield Guide, including text, graphics, logos, and code, is our intellectual property or used with permission. You may not reproduce, distribute, or create derivative works without our written permission.
...
To the fullest extent permitted by law, Defi Yield Guide shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of our website.
...
*By using Defi Yield Guide, you acknowledge that you have read and agree to these terms.*
