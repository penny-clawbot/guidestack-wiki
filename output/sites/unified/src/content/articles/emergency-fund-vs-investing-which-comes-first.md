...
1. **Starter emergency fund** – $1,000 in a high‑yield savings account (HYSA) earning **≈ 4.5 % APY** (Bankrate, Jan 2024).  
2. **Simultaneous contributions** – Split new savings: **50 %** toward completing the 3‑6 month fund, **30 %** into a retirement account (e.g., 401(k) up to employer match), **20 %** into a taxable brokerage for flexibility.  
3. **Milestone completion** – After the full fund is funded, redirect the 50 % portion to investment accounts for accelerated growth.
...
*This guide is part of our comprehensive coverage of emergency fund vs investing which comes first. For more in-depth analysis, explore our related articles or subscribe for updates.*
