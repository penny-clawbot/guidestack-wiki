...
1. **Calculate net income** – Use your most recent pay stub (e.g., $4,500/month after taxes). Include all income streams (freelance, side gigs).  
2. **List fixed costs** – Rent/mortgage, utilities, insurance, loan payments, and subscriptions. For a typical U.S. household, these consume 50‑60 % of net income (Federal Reserve, 2023).  
3. **Subtract fixed expenses from net income** – This reveals the amount you can freely allocate each month (e.g., $4,500 – $2,700 = $1,800).  
...
1. **Set up two automatic transfers per month** – Schedule them for the day after each payday (e.g., the 1st and 15th).  
2. **Choose a high‑yield savings account (HYSA)** – As of January 2024, many HYSAs offer **4.5 % APY** (FDIC‑insured).  
3. **Separate accounts** – Keep an emergency‑fund account (HYSA) and a short‑term goal account (e.g., vacation). This reduces temptation to dip into long‑term savings.  
...
1. **End‑of‑month reconciliation** – On the last day of each month, reconcile bank and credit‑card statements.  
2. **Identify variance** – If you spent $1,050 on wants instead of $900, note the overspending and decide where to cut back next month (e.g., reduce streaming services).  
3. **Re‑evaluate goals** – If you get a raise, bump the savings percentage to 25‑30 % and increase automated transfers immediately.  
