...
![Hero image for how to use 1inch aggregator](https://picsum.photos/seed/how-to-use-1inch-aggregator-hero/1200/630)
...
1inch works with **MetaMask, WalletConnect, Coinbase Wallet, Trust Wallet**, and several other EVM‑compatible wallets. As of 2026, the aggregator supports **10+ networks**: Ethereum, BNB Chain, Polygon, Arbitrum, Optimism, Gnosis Chain, Avalanche, Fantom, Klaytn, and Harmony (source: 1inch Documentation, 2024).  
...
![Illustration for how to use 1inch aggregator](https://picsum.photos/seed/how-to-use-1inch-aggregator-mid/1200/630)
